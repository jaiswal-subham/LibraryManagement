...
public class OrderEventPublisher {
    ...
    public OrderEventPublisher(ApplicationProperties applicationProperties, RabbitTemplate rabbitTemplate) {
    ...
    public void publishOrderCreatedEvent(OrderCreatedEvent message) {
        ...
        rabbitTemplate.convertAndSend(applicationProperties.orderEventsExchange(), applicationProperties.newOrdersQueue(), message);
    ...
    public void publishOrderDeliveredEvent(OrderDeliveredEvent message) {
        ...
        rabbitTemplate.convertAndSend(applicationProperties.orderEventsExchange(), applicationProperties.deliveredOrdersQueue(), message);
        System.out.println("Message sent successfully!");
    }
    ...
    public void publishOrderCancelledEvent(OrderCancelledEvent message) {
        ...
        rabbitTemplate.convertAndSend(applicationProperties.orderEventsExchange(), applicationProperties.cancelledOrdersQueue(), message);
        System.out.println("Message sent successfully!");
    }

    public void publishOrderErrorEvent(OrderErrorEvent message) {
        System.out.println("Sending message to RabbitMQ OrderCancelledEvent" + message);
        rabbitTemplate.convertAndSend(applicationProperties.orderEventsExchange(), applicationProperties.errorOrdersQueue(), message);
