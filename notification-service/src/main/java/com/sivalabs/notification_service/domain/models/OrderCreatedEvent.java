...
public class OrderCreatedEvent {
    ...
    public String toString() {
        return "OrderCreatedEvent{" + "eventId='"
                + eventId + '\'' + ", orderNumber='"
                + orderNumber + '\'' + ", items="
                + items + ", customerName='"
                + customerName + '\'' + ", customerEmail='"
                + customerEmail + '\'' + ", customerPhone='"
                + customerPhone + '\'' + ", deliveryAddressLine1='"
                + deliveryAddressLine1 + '\'' + ", deliveryAddressLine2='"
                + deliveryAddressLine2 + '\'' + ", deliveryAddressCity='"
                + deliveryAddressCity + '\'' + ", deliveryAddressState='"
                + deliveryAddressState + '\'' + ", deliveryAddressZipCode='"
                + deliveryAddressZipCode + '\'' + ", deliveryAddressCountry='"
                + deliveryAddressCountry + '\'' + ", createdAt="
                + createdAt + '}';
    }
}
