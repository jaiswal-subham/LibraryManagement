package com.sivalabs.notification_service.domain;

import com.sivalabs.notification_service.ApplicationProperties;
...
public class NotificationService {
    ...
    private final String from = "subhamjaiswalamell@gmail.com";
    ...
    public void sendOrderCreatedNotification(OrderCreatedEvent event) {
        String message =
                ...
                ===================================================
                """
                        .formatted(event.getCustomerName(), event.getOrderNumber());
        log.info("\n{}", message);
        sendEmail(event.getCustomerEmail(), "Order Created Notification", message);
    }
    ...
    public void sendOrderDeliveredNotification(OrderDeliveredEvent event) {
        String message =
                ...
                """
                        .formatted(event.getCustomerName(), event.getOrderNumber());
        log.info("\n{}", message);
        sendEmail(event.getCustomerEmail(), "Order Delivered Notification", message);
    }
    ...
    public void sendOrderCancelledNotification(OrderCancelledEvent event) {
        String message =
                ...
                ===================================================
                """
                        .formatted(event.getCustomerName(), event.getOrderNumber(), event.getReason());
        log.info("\n{}", message);
        sendEmail(event.getCustomerEmail(), "Order Cancelled Notification", message);
    }
    ...
    public void sendOrderErrorEventNotification(OrderErrorEvent event) {
        String message =
                ...
                ===================================================
                """
                        .formatted(from, event.getOrderNumber(), event.getReason());
        log.info("\n{}", message);
        sendEmail(from, "Order Processing Failure Notification", message);
    }
